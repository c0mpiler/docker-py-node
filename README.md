...
--- | --- | --- | ---
`python3.14-nodejs25` | 3.14.2 | 25.5.0 | bookworm
`python3.14-nodejs25-slim` | 3.14.2 | 25.5.0 | slim
...
`python3.13-nodejs25` | 3.13.11 | 25.5.0 | bookworm
`python3.13-nodejs25-slim` | 3.13.11 | 25.5.0 | slim
...
`python3.13-nodejs25-bullseye` | 3.13.6 | 25.5.0 | bullseye
...
`python3.12-nodejs25` | 3.12.12 | 25.5.0 | bookworm
`python3.12-nodejs25-slim` | 3.12.12 | 25.5.0 | slim
...
`python3.12-nodejs25-bullseye` | 3.12.11 | 25.5.0 | bullseye
...
`python3.11-nodejs25` | 3.11.14 | 25.5.0 | bookworm
`python3.11-nodejs25-slim` | 3.11.14 | 25.5.0 | slim
...
`python3.11-nodejs25-bullseye` | 3.11.13 | 25.5.0 | bullseye
...
`python3.10-nodejs25` | 3.10.19 | 25.5.0 | bookworm
`python3.10-nodejs25-slim` | 3.10.19 | 25.5.0 | slim
...
`python3.10-nodejs25-bullseye` | 3.10.18 | 25.5.0 | bullseye

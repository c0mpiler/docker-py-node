...
--- | --- | --- | ---
`python3.14-nodejs25` | 3.14.3 | 25.8.1 | bookworm
...
`python3.13-nodejs25` | 3.13.12 | 25.8.1 | bookworm
...
`python3.13-nodejs25-bullseye` | 3.13.6 | 25.8.1 | bullseye
...
`python3.12-nodejs25` | 3.12.13 | 25.8.1 | bookworm
...
`python3.12-nodejs25-bullseye` | 3.12.11 | 25.8.1 | bullseye
...
`python3.11-nodejs25` | 3.11.15 | 25.8.1 | bookworm
...
`python3.11-nodejs25-bullseye` | 3.11.13 | 25.8.1 | bullseye
...
`python3.10-nodejs25` | 3.10.20 | 25.8.1 | bookworm
...
`python3.10-nodejs25-bullseye` | 3.10.18 | 25.8.1 | bullseye

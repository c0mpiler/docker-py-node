...
`python3.14-nodejs22-alpine` | 3.14.2 | 22.21.1 | alpine
`python3.14-nodejs20` | 3.14.2 | 20.20.0 | bookworm
`python3.14-nodejs20-slim` | 3.14.2 | 20.20.0 | slim
`python3.14-nodejs20-alpine` | 3.14.2 | 20.19.6 | alpine
...
`python3.13-nodejs22-alpine` | 3.13.11 | 22.21.1 | alpine
`python3.13-nodejs20` | 3.13.11 | 20.20.0 | bookworm
`python3.13-nodejs20-slim` | 3.13.11 | 20.20.0 | slim
`python3.13-nodejs20-alpine` | 3.13.11 | 20.19.6 | alpine
...
`python3.12-nodejs20-alpine` | 3.12.12 | 20.19.6 | alpine
...
`python3.11-nodejs20-alpine` | 3.11.14 | 20.19.6 | alpine
...
`python3.10-nodejs20-alpine` | 3.10.19 | 20.19.6 | alpine

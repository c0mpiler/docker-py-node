...
`python3.14-nodejs24-alpine` | 3.14.3 | 24.13.1 | alpine
...
`python3.13-nodejs24-alpine` | 3.13.12 | 24.13.1 | alpine
...
`python3.13-nodejs25-bullseye` | 3.13.6 | 25.6.1 | bullseye
`python3.13-nodejs24-bullseye` | 3.13.6 | 24.13.1 | bullseye
...
`python3.12-nodejs24-alpine` | 3.12.12 | 24.13.1 | alpine
...
`python3.12-nodejs25-bullseye` | 3.12.11 | 25.6.1 | bullseye
`python3.12-nodejs24-bullseye` | 3.12.11 | 24.13.1 | bullseye
...
`python3.11-nodejs24-alpine` | 3.11.14 | 24.13.1 | alpine
...
`python3.11-nodejs25-bullseye` | 3.11.13 | 25.6.1 | bullseye
`python3.11-nodejs24-bullseye` | 3.11.13 | 24.13.1 | bullseye
...
`python3.10-nodejs24-alpine` | 3.10.19 | 24.13.1 | alpine
...
`python3.10-nodejs25-bullseye` | 3.10.18 | 25.6.1 | bullseye
`python3.10-nodejs24-bullseye` | 3.10.18 | 24.13.1 | bullseye

...
`python3.14-nodejs24` | 3.14.4 | 24.14.1 | bookworm
`python3.14-nodejs24-slim` | 3.14.4 | 24.14.1 | slim
`python3.14-nodejs24-alpine` | 3.14.4 | 24.14.1 | alpine
...
`python3.14-nodejs20` | 3.14.4 | 20.20.2 | bookworm
...
`python3.13-nodejs24` | 3.13.13 | 24.14.1 | bookworm
`python3.13-nodejs24-slim` | 3.13.13 | 24.14.1 | slim
`python3.13-nodejs24-alpine` | 3.13.13 | 24.14.1 | alpine
`python3.13-nodejs22` | 3.13.13 | 22.22.2 | bookworm
`python3.13-nodejs22-slim` | 3.13.13 | 22.22.2 | slim
`python3.13-nodejs22-alpine` | 3.13.13 | 22.22.2 | alpine
`python3.13-nodejs20` | 3.13.13 | 20.20.2 | bookworm
...
`python3.13-nodejs24-bullseye` | 3.13.6 | 24.14.1 | bullseye
`python3.13-nodejs22-bullseye` | 3.13.6 | 22.22.2 | bullseye
`python3.13-nodejs20-bullseye` | 3.13.6 | 20.20.2 | bullseye
...
`python3.12-nodejs24-bullseye` | 3.12.11 | 24.14.1 | bullseye
`python3.12-nodejs22-bullseye` | 3.12.11 | 22.22.2 | bullseye
`python3.12-nodejs20-bullseye` | 3.12.11 | 20.20.2 | bullseye
...
`python3.11-nodejs24-bullseye` | 3.11.13 | 24.14.1 | bullseye
`python3.11-nodejs22-bullseye` | 3.11.13 | 22.22.2 | bullseye
`python3.11-nodejs20-bullseye` | 3.11.13 | 20.20.2 | bullseye
...
`python3.10-nodejs24-bullseye` | 3.10.18 | 24.14.1 | bullseye
`python3.10-nodejs22-bullseye` | 3.10.18 | 22.22.2 | bullseye
`python3.10-nodejs20-bullseye` | 3.10.18 | 20.20.2 | bullseye

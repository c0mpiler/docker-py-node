...
--- | --- | --- | ---
`python3.14-nodejs26` | 3.14.6 | 26.3.0 | bookworm
`python3.14-nodejs26-slim` | 3.14.6 | 26.3.0 | slim
`python3.14-nodejs26-alpine` | 3.14.6 | 26.3.0 | alpine
`python3.14-nodejs24` | 3.14.6 | 24.16.0 | bookworm
`python3.14-nodejs24-slim` | 3.14.6 | 24.16.0 | slim
`python3.14-nodejs24-alpine` | 3.14.6 | 24.16.0 | alpine
`python3.14-nodejs22` | 3.14.6 | 22.22.3 | bookworm
`python3.14-nodejs22-slim` | 3.14.6 | 22.22.3 | slim
`python3.14-nodejs22-alpine` | 3.14.6 | 22.22.3 | alpine
`python3.13-nodejs26` | 3.13.14 | 26.3.0 | bookworm
`python3.13-nodejs26-slim` | 3.13.14 | 26.3.0 | slim
`python3.13-nodejs26-alpine` | 3.13.14 | 26.3.0 | alpine
`python3.13-nodejs24` | 3.13.14 | 24.16.0 | bookworm
`python3.13-nodejs24-slim` | 3.13.14 | 24.16.0 | slim
`python3.13-nodejs24-alpine` | 3.13.14 | 24.16.0 | alpine
`python3.13-nodejs22` | 3.13.14 | 22.22.3 | bookworm
`python3.13-nodejs22-slim` | 3.13.14 | 22.22.3 | slim
`python3.13-nodejs22-alpine` | 3.13.14 | 22.22.3 | alpine
`python3.13-nodejs26-bullseye` | 3.13.6 | 26.3.0 | bullseye
`python3.13-nodejs24-bullseye` | 3.13.6 | 24.16.0 | bullseye
`python3.13-nodejs22-bullseye` | 3.13.6 | 22.22.3 | bullseye
`python3.12-nodejs26` | 3.12.13 | 26.3.0 | bookworm
...
`python3.10-nodejs26-bullseye` | 3.10.18 | 26.3.0 | bullseye

...
--- | --- | --- | ---
`python3.14-nodejs25` | 3.14.3 | 25.7.0 | bookworm
`python3.14-nodejs25-slim` | 3.14.3 | 25.7.0 | slim
`python3.14-nodejs25-alpine` | 3.14.3 | 25.7.0 | alpine
`python3.14-nodejs24` | 3.14.3 | 24.14.0 | bookworm
`python3.14-nodejs24-slim` | 3.14.3 | 24.14.0 | slim
`python3.14-nodejs24-alpine` | 3.14.3 | 24.14.0 | alpine
`python3.14-nodejs22` | 3.14.3 | 22.22.0 | bookworm
`python3.14-nodejs22-slim` | 3.14.3 | 22.22.0 | slim
`python3.14-nodejs22-alpine` | 3.14.3 | 22.22.0 | alpine
`python3.14-nodejs20` | 3.14.3 | 20.20.0 | bookworm
`python3.14-nodejs20-slim` | 3.14.3 | 20.20.0 | slim
`python3.14-nodejs20-alpine` | 3.14.3 | 20.20.0 | alpine
`python3.13-nodejs25` | 3.13.12 | 25.7.0 | bookworm
`python3.13-nodejs25-slim` | 3.13.12 | 25.7.0 | slim
`python3.13-nodejs25-alpine` | 3.13.12 | 25.7.0 | alpine
`python3.13-nodejs24` | 3.13.12 | 24.14.0 | bookworm
`python3.13-nodejs24-slim` | 3.13.12 | 24.14.0 | slim
`python3.13-nodejs24-alpine` | 3.13.12 | 24.14.0 | alpine
`python3.13-nodejs22` | 3.13.12 | 22.22.0 | bookworm
`python3.13-nodejs22-slim` | 3.13.12 | 22.22.0 | slim
`python3.13-nodejs22-alpine` | 3.13.12 | 22.22.0 | alpine
`python3.13-nodejs20` | 3.13.12 | 20.20.0 | bookworm
`python3.13-nodejs20-slim` | 3.13.12 | 20.20.0 | slim
`python3.13-nodejs20-alpine` | 3.13.12 | 20.20.0 | alpine
`python3.13-nodejs25-bullseye` | 3.13.6 | 25.7.0 | bullseye
`python3.13-nodejs24-bullseye` | 3.13.6 | 24.14.0 | bullseye
`python3.13-nodejs22-bullseye` | 3.13.6 | 22.22.0 | bullseye
`python3.13-nodejs20-bullseye` | 3.13.6 | 20.20.0 | bullseye
`python3.12-nodejs25` | 3.12.12 | 25.7.0 | bookworm
`python3.12-nodejs25-slim` | 3.12.12 | 25.7.0 | slim
`python3.12-nodejs25-alpine` | 3.12.12 | 25.7.0 | alpine
`python3.12-nodejs24` | 3.12.12 | 24.14.0 | bookworm
`python3.12-nodejs24-slim` | 3.12.12 | 24.14.0 | slim
`python3.12-nodejs24-alpine` | 3.12.12 | 24.14.0 | alpine
...
`python3.12-nodejs25-bullseye` | 3.12.11 | 25.7.0 | bullseye
`python3.12-nodejs24-bullseye` | 3.12.11 | 24.14.0 | bullseye
`python3.12-nodejs22-bullseye` | 3.12.11 | 22.22.0 | bullseye
`python3.12-nodejs20-bullseye` | 3.12.11 | 20.20.0 | bullseye
`python3.11-nodejs25` | 3.11.14 | 25.7.0 | bookworm
`python3.11-nodejs25-slim` | 3.11.14 | 25.7.0 | slim
`python3.11-nodejs25-alpine` | 3.11.14 | 25.7.0 | alpine
`python3.11-nodejs24` | 3.11.14 | 24.14.0 | bookworm
`python3.11-nodejs24-slim` | 3.11.14 | 24.14.0 | slim
`python3.11-nodejs24-alpine` | 3.11.14 | 24.14.0 | alpine
...
`python3.11-nodejs25-bullseye` | 3.11.13 | 25.7.0 | bullseye
`python3.11-nodejs24-bullseye` | 3.11.13 | 24.14.0 | bullseye
`python3.11-nodejs22-bullseye` | 3.11.13 | 22.22.0 | bullseye
`python3.11-nodejs20-bullseye` | 3.11.13 | 20.20.0 | bullseye
`python3.10-nodejs25` | 3.10.19 | 25.7.0 | bookworm
`python3.10-nodejs25-slim` | 3.10.19 | 25.7.0 | slim
`python3.10-nodejs25-alpine` | 3.10.19 | 25.7.0 | alpine
`python3.10-nodejs24` | 3.10.19 | 24.14.0 | bookworm
`python3.10-nodejs24-slim` | 3.10.19 | 24.14.0 | slim
`python3.10-nodejs24-alpine` | 3.10.19 | 24.14.0 | alpine
...
`python3.10-nodejs25-bullseye` | 3.10.18 | 25.7.0 | bullseye
`python3.10-nodejs24-bullseye` | 3.10.18 | 24.14.0 | bullseye

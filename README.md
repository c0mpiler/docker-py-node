...
--- | --- | --- | ---
`python3.14-nodejs26` | 3.14.6 | 26.4.0 | bookworm
`python3.14-nodejs26-slim` | 3.14.6 | 26.4.0 | slim
`python3.14-nodejs26-alpine` | 3.14.6 | 26.4.0 | alpine
...
`python3.13-nodejs26` | 3.13.14 | 26.4.0 | bookworm
`python3.13-nodejs26-slim` | 3.13.14 | 26.4.0 | slim
`python3.13-nodejs26-alpine` | 3.13.14 | 26.4.0 | alpine
...
`python3.13-nodejs26-bullseye` | 3.13.6 | 26.4.0 | bullseye
`python3.13-nodejs24-bullseye` | 3.13.6 | 24.18.0 | bullseye
`python3.13-nodejs22-bullseye` | 3.13.6 | 22.23.1 | bullseye
`python3.12-nodejs26` | 3.12.13 | 26.4.0 | bookworm
`python3.12-nodejs26-slim` | 3.12.13 | 26.4.0 | slim
`python3.12-nodejs26-alpine` | 3.12.13 | 26.4.0 | alpine
...
`python3.12-nodejs26-bullseye` | 3.12.11 | 26.4.0 | bullseye
`python3.12-nodejs24-bullseye` | 3.12.11 | 24.18.0 | bullseye
`python3.12-nodejs22-bullseye` | 3.12.11 | 22.23.1 | bullseye
`python3.11-nodejs26` | 3.11.15 | 26.4.0 | bookworm
`python3.11-nodejs26-slim` | 3.11.15 | 26.4.0 | slim
`python3.11-nodejs26-alpine` | 3.11.15 | 26.4.0 | alpine
...
`python3.11-nodejs26-bullseye` | 3.11.13 | 26.4.0 | bullseye
`python3.11-nodejs24-bullseye` | 3.11.13 | 24.18.0 | bullseye
`python3.11-nodejs22-bullseye` | 3.11.13 | 22.23.1 | bullseye
`python3.10-nodejs26` | 3.10.20 | 26.4.0 | bookworm
`python3.10-nodejs26-slim` | 3.10.20 | 26.4.0 | slim
`python3.10-nodejs26-alpine` | 3.10.20 | 26.4.0 | alpine
...
`python3.10-nodejs26-bullseye` | 3.10.18 | 26.4.0 | bullseye

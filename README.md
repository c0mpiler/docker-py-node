...
--- | --- | --- | ---
`python3.13-nodejs24` | 3.13.3 | 24.0.2 | bookworm
`python3.13-nodejs24-bullseye` | 3.13.3 | 24.0.2 | bullseye
`python3.13-nodejs24-slim` | 3.13.3 | 24.0.2 | slim
...
`python3.13-nodejs23-alpine` | 3.13.3 | 23.11.1 | alpine
`python3.13-nodejs22` | 3.13.3 | 22.15.1 | bookworm
`python3.13-nodejs22-bullseye` | 3.13.3 | 22.15.1 | bullseye
`python3.13-nodejs22-slim` | 3.13.3 | 22.15.1 | slim
`python3.13-nodejs22-alpine` | 3.13.3 | 22.15.1 | alpine
`python3.13-nodejs20` | 3.13.3 | 20.19.2 | bookworm
`python3.13-nodejs20-bullseye` | 3.13.3 | 20.19.2 | bullseye
`python3.13-nodejs20-slim` | 3.13.3 | 20.19.2 | slim
`python3.13-nodejs20-alpine` | 3.13.3 | 20.19.2 | alpine
`python3.12-nodejs24` | 3.12.10 | 24.0.2 | bookworm
`python3.12-nodejs24-bullseye` | 3.12.10 | 24.0.2 | bullseye
`python3.12-nodejs24-slim` | 3.12.10 | 24.0.2 | slim
...
`python3.12-nodejs23-alpine` | 3.12.10 | 23.11.1 | alpine
`python3.12-nodejs22` | 3.12.10 | 22.15.1 | bookworm
`python3.12-nodejs22-bullseye` | 3.12.10 | 22.15.1 | bullseye
`python3.12-nodejs22-slim` | 3.12.10 | 22.15.1 | slim
`python3.12-nodejs22-alpine` | 3.12.10 | 22.15.1 | alpine
`python3.12-nodejs20` | 3.12.10 | 20.19.2 | bookworm
`python3.12-nodejs20-bullseye` | 3.12.10 | 20.19.2 | bullseye
`python3.12-nodejs20-slim` | 3.12.10 | 20.19.2 | slim
`python3.12-nodejs20-alpine` | 3.12.10 | 20.19.2 | alpine
`python3.11-nodejs24` | 3.11.12 | 24.0.2 | bookworm
`python3.11-nodejs24-bullseye` | 3.11.12 | 24.0.2 | bullseye
`python3.11-nodejs24-slim` | 3.11.12 | 24.0.2 | slim
...
`python3.11-nodejs23-alpine` | 3.11.12 | 23.11.1 | alpine
`python3.11-nodejs22` | 3.11.12 | 22.15.1 | bookworm
`python3.11-nodejs22-bullseye` | 3.11.12 | 22.15.1 | bullseye
`python3.11-nodejs22-slim` | 3.11.12 | 22.15.1 | slim
`python3.11-nodejs22-alpine` | 3.11.12 | 22.15.1 | alpine
`python3.11-nodejs20` | 3.11.12 | 20.19.2 | bookworm
`python3.11-nodejs20-bullseye` | 3.11.12 | 20.19.2 | bullseye
`python3.11-nodejs20-slim` | 3.11.12 | 20.19.2 | slim
`python3.11-nodejs20-alpine` | 3.11.12 | 20.19.2 | alpine
`python3.10-nodejs24` | 3.10.17 | 24.0.2 | bookworm
`python3.10-nodejs24-bullseye` | 3.10.17 | 24.0.2 | bullseye
`python3.10-nodejs24-slim` | 3.10.17 | 24.0.2 | slim
...
`python3.10-nodejs23-alpine` | 3.10.17 | 23.11.1 | alpine
`python3.10-nodejs22` | 3.10.17 | 22.15.1 | bookworm
...
`python3.10-nodejs20-alpine` | 3.10.17 | 20.19.2 | alpine
...
`python3.9-nodejs23-alpine` | 3.9.22 | 23.11.1 | alpine
...
`python3.9-nodejs20-alpine` | 3.9.22 | 20.19.2 | alpine

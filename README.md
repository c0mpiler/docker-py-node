...
--- | --- | --- | ---
`python3.13-nodejs23` | 3.13.2 | 23.9.0 | bookworm
`python3.13-nodejs23-bullseye` | 3.13.2 | 23.9.0 | bullseye
`python3.13-nodejs23-slim` | 3.13.2 | 23.9.0 | slim
`python3.13-nodejs23-alpine` | 3.13.2 | 23.9.0 | alpine
...
`python3.13-nodejs20-alpine` | 3.13.2 | 20.18.3 | alpine
...
`python3.12-nodejs23` | 3.12.9 | 23.9.0 | bookworm
`python3.12-nodejs23-bullseye` | 3.12.9 | 23.9.0 | bullseye
`python3.12-nodejs23-slim` | 3.12.9 | 23.9.0 | slim
`python3.12-nodejs23-alpine` | 3.12.9 | 23.9.0 | alpine
...
`python3.12-nodejs20-alpine` | 3.12.9 | 20.18.3 | alpine
...
`python3.11-nodejs23` | 3.11.11 | 23.9.0 | bookworm
`python3.11-nodejs23-bullseye` | 3.11.11 | 23.9.0 | bullseye
`python3.11-nodejs23-slim` | 3.11.11 | 23.9.0 | slim
`python3.11-nodejs23-alpine` | 3.11.11 | 23.9.0 | alpine
...
`python3.11-nodejs20-alpine` | 3.11.11 | 20.18.3 | alpine
...
`python3.10-nodejs23` | 3.10.16 | 23.9.0 | bookworm
`python3.10-nodejs23-bullseye` | 3.10.16 | 23.9.0 | bullseye
`python3.10-nodejs23-slim` | 3.10.16 | 23.9.0 | slim
`python3.10-nodejs23-alpine` | 3.10.16 | 23.9.0 | alpine
...
`python3.10-nodejs20-alpine` | 3.10.16 | 20.18.3 | alpine
...
`python3.9-nodejs23` | 3.9.21 | 23.9.0 | bookworm
`python3.9-nodejs23-bullseye` | 3.9.21 | 23.9.0 | bullseye
`python3.9-nodejs23-slim` | 3.9.21 | 23.9.0 | slim
`python3.9-nodejs23-alpine` | 3.9.21 | 23.9.0 | alpine
...
`python3.9-nodejs20-alpine` | 3.9.21 | 20.18.3 | alpine

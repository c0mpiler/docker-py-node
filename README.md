...
--- | --- | --- | ---
`python3.14-nodejs25` | 3.14.2 | 25.4.0 | bookworm
`python3.14-nodejs25-slim` | 3.14.2 | 25.4.0 | slim
`python3.14-nodejs25-alpine` | 3.14.2 | 25.4.0 | alpine
`python3.14-nodejs24` | 3.14.2 | 24.13.0 | bookworm
`python3.14-nodejs24-slim` | 3.14.2 | 24.13.0 | slim
`python3.14-nodejs24-alpine` | 3.14.2 | 24.13.0 | alpine
...
`python3.13-nodejs25` | 3.13.11 | 25.4.0 | bookworm
`python3.13-nodejs25-slim` | 3.13.11 | 25.4.0 | slim
`python3.13-nodejs25-alpine` | 3.13.11 | 25.4.0 | alpine
`python3.13-nodejs24` | 3.13.11 | 24.13.0 | bookworm
`python3.13-nodejs24-slim` | 3.13.11 | 24.13.0 | slim
`python3.13-nodejs24-alpine` | 3.13.11 | 24.13.0 | alpine
...
`python3.13-nodejs25-bullseye` | 3.13.6 | 25.4.0 | bullseye
...
`python3.12-nodejs25` | 3.12.12 | 25.4.0 | bookworm
`python3.12-nodejs25-slim` | 3.12.12 | 25.4.0 | slim
`python3.12-nodejs25-alpine` | 3.12.12 | 25.4.0 | alpine
...
`python3.12-nodejs25-bullseye` | 3.12.11 | 25.4.0 | bullseye
...
`python3.11-nodejs25` | 3.11.14 | 25.4.0 | bookworm
`python3.11-nodejs25-slim` | 3.11.14 | 25.4.0 | slim
`python3.11-nodejs25-alpine` | 3.11.14 | 25.4.0 | alpine
...
`python3.11-nodejs25-bullseye` | 3.11.13 | 25.4.0 | bullseye
...
`python3.10-nodejs25` | 3.10.19 | 25.4.0 | bookworm
`python3.10-nodejs25-slim` | 3.10.19 | 25.4.0 | slim
`python3.10-nodejs25-alpine` | 3.10.19 | 25.4.0 | alpine
...
`python3.10-nodejs25-bullseye` | 3.10.18 | 25.4.0 | bullseye

...
--- | --- | --- | ---
`python3.14-nodejs26` | 3.14.6 | 26.5.1 | bookworm
`python3.14-nodejs26-slim` | 3.14.6 | 26.5.1 | slim
`python3.14-nodejs26-alpine` | 3.14.6 | 26.5.1 | alpine
`python3.14-nodejs24` | 3.14.6 | 24.18.1 | bookworm
`python3.14-nodejs24-slim` | 3.14.6 | 24.18.1 | slim
`python3.14-nodejs24-alpine` | 3.14.6 | 24.18.1 | alpine
`python3.14-nodejs22` | 3.14.6 | 22.23.2 | bookworm
`python3.14-nodejs22-slim` | 3.14.6 | 22.23.2 | slim
`python3.14-nodejs22-alpine` | 3.14.6 | 22.23.2 | alpine
`python3.13-nodejs26` | 3.13.14 | 26.5.1 | bookworm
`python3.13-nodejs26-slim` | 3.13.14 | 26.5.1 | slim
`python3.13-nodejs26-alpine` | 3.13.14 | 26.5.1 | alpine
`python3.13-nodejs24` | 3.13.14 | 24.18.1 | bookworm
`python3.13-nodejs24-slim` | 3.13.14 | 24.18.1 | slim
`python3.13-nodejs24-alpine` | 3.13.14 | 24.18.1 | alpine
`python3.13-nodejs22` | 3.13.14 | 22.23.2 | bookworm
`python3.13-nodejs22-slim` | 3.13.14 | 22.23.2 | slim
`python3.13-nodejs22-alpine` | 3.13.14 | 22.23.2 | alpine
`python3.13-nodejs26-bullseye` | 3.13.6 | 26.5.1 | bullseye
`python3.13-nodejs24-bullseye` | 3.13.6 | 24.18.1 | bullseye
`python3.13-nodejs22-bullseye` | 3.13.6 | 22.23.2 | bullseye
`python3.12-nodejs26` | 3.12.13 | 26.5.1 | bookworm
`python3.12-nodejs26-slim` | 3.12.13 | 26.5.1 | slim
`python3.12-nodejs26-alpine` | 3.12.13 | 26.5.1 | alpine
`python3.12-nodejs24` | 3.12.13 | 24.18.1 | bookworm
`python3.12-nodejs24-slim` | 3.12.13 | 24.18.1 | slim
`python3.12-nodejs24-alpine` | 3.12.13 | 24.18.1 | alpine
`python3.12-nodejs22` | 3.12.13 | 22.23.2 | bookworm
`python3.12-nodejs22-slim` | 3.12.13 | 22.23.2 | slim
`python3.12-nodejs22-alpine` | 3.12.13 | 22.23.2 | alpine
`python3.12-nodejs26-bullseye` | 3.12.11 | 26.5.1 | bullseye
`python3.12-nodejs24-bullseye` | 3.12.11 | 24.18.1 | bullseye
`python3.12-nodejs22-bullseye` | 3.12.11 | 22.23.2 | bullseye
`python3.11-nodejs26` | 3.11.15 | 26.5.1 | bookworm
`python3.11-nodejs26-slim` | 3.11.15 | 26.5.1 | slim
`python3.11-nodejs26-alpine` | 3.11.15 | 26.5.1 | alpine
`python3.11-nodejs24` | 3.11.15 | 24.18.1 | bookworm
`python3.11-nodejs24-slim` | 3.11.15 | 24.18.1 | slim
`python3.11-nodejs24-alpine` | 3.11.15 | 24.18.1 | alpine
`python3.11-nodejs22` | 3.11.15 | 22.23.2 | bookworm
`python3.11-nodejs22-slim` | 3.11.15 | 22.23.2 | slim
`python3.11-nodejs22-alpine` | 3.11.15 | 22.23.2 | alpine
`python3.11-nodejs26-bullseye` | 3.11.13 | 26.5.1 | bullseye
`python3.11-nodejs24-bullseye` | 3.11.13 | 24.18.1 | bullseye
`python3.11-nodejs22-bullseye` | 3.11.13 | 22.23.2 | bullseye
`python3.10-nodejs26` | 3.10.20 | 26.5.1 | bookworm
`python3.10-nodejs26-slim` | 3.10.20 | 26.5.1 | slim
`python3.10-nodejs26-alpine` | 3.10.20 | 26.5.1 | alpine
`python3.10-nodejs24` | 3.10.20 | 24.18.1 | bookworm
`python3.10-nodejs24-slim` | 3.10.20 | 24.18.1 | slim
`python3.10-nodejs24-alpine` | 3.10.20 | 24.18.1 | alpine
`python3.10-nodejs22` | 3.10.20 | 22.23.2 | bookworm
`python3.10-nodejs22-slim` | 3.10.20 | 22.23.2 | slim
`python3.10-nodejs22-alpine` | 3.10.20 | 22.23.2 | alpine
`python3.10-nodejs26-bullseye` | 3.10.18 | 26.5.1 | bullseye
`python3.10-nodejs24-bullseye` | 3.10.18 | 24.18.1 | bullseye
`python3.10-nodejs22-bullseye` | 3.10.18 | 22.23.2 | bullseye

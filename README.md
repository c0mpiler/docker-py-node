...
--- | --- | --- | ---
`python3.14-nodejs26` | 3.14.7 | 26.7.0 | bookworm
`python3.14-nodejs26-slim` | 3.14.7 | 26.7.0 | slim
`python3.14-nodejs26-alpine` | 3.14.7 | 26.7.0 | alpine
`python3.14-nodejs24` | 3.14.7 | 24.19.0 | bookworm
`python3.14-nodejs24-slim` | 3.14.7 | 24.19.0 | slim
`python3.14-nodejs24-alpine` | 3.14.7 | 24.19.0 | alpine
`python3.14-nodejs22` | 3.14.7 | 22.23.2 | bookworm
`python3.14-nodejs22-slim` | 3.14.7 | 22.23.2 | slim
`python3.14-nodejs22-alpine` | 3.14.7 | 22.23.2 | alpine
`python3.13-nodejs26` | 3.13.14 | 26.7.0 | bookworm
`python3.13-nodejs26-slim` | 3.13.14 | 26.7.0 | slim
`python3.13-nodejs26-alpine` | 3.13.14 | 26.7.0 | alpine
...
`python3.13-nodejs26-bullseye` | 3.13.6 | 26.7.0 | bullseye
`python3.13-nodejs24-bullseye` | 3.13.6 | 24.19.0 | bullseye
`python3.13-nodejs22-bullseye` | 3.13.6 | 22.23.2 | bullseye
`python3.12-nodejs26` | 3.12.13 | 26.7.0 | bookworm
`python3.12-nodejs26-slim` | 3.12.13 | 26.7.0 | slim
`python3.12-nodejs26-alpine` | 3.12.13 | 26.7.0 | alpine
...
`python3.12-nodejs26-bullseye` | 3.12.11 | 26.7.0 | bullseye
`python3.12-nodejs24-bullseye` | 3.12.11 | 24.19.0 | bullseye
`python3.12-nodejs22-bullseye` | 3.12.11 | 22.23.2 | bullseye
`python3.11-nodejs26` | 3.11.15 | 26.7.0 | bookworm
`python3.11-nodejs26-slim` | 3.11.15 | 26.7.0 | slim
`python3.11-nodejs26-alpine` | 3.11.15 | 26.7.0 | alpine
...
`python3.11-nodejs26-bullseye` | 3.11.13 | 26.7.0 | bullseye
`python3.11-nodejs24-bullseye` | 3.11.13 | 24.19.0 | bullseye
`python3.11-nodejs22-bullseye` | 3.11.13 | 22.23.2 | bullseye
`python3.10-nodejs26` | 3.10.20 | 26.7.0 | bookworm
`python3.10-nodejs26-slim` | 3.10.20 | 26.7.0 | slim
`python3.10-nodejs26-alpine` | 3.10.20 | 26.7.0 | alpine
...
`python3.10-nodejs26-bullseye` | 3.10.18 | 26.7.0 | bullseye

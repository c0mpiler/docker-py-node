...
`python3.13-nodejs26-bullseye` | 3.13.6 | 26.1.0 | bullseye
...
`python3.12-nodejs26` | 3.12.13 | 26.1.0 | bookworm
...
`python3.12-nodejs26-bullseye` | 3.12.11 | 26.1.0 | bullseye
...
`python3.11-nodejs26` | 3.11.15 | 26.1.0 | bookworm
...
`python3.11-nodejs26-bullseye` | 3.11.13 | 26.1.0 | bullseye
...
`python3.10-nodejs26` | 3.10.20 | 26.1.0 | bookworm
...
`python3.10-nodejs26-bullseye` | 3.10.18 | 26.1.0 | bullseye
